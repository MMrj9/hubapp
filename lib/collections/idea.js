...
Meteor.methods({
    ideaInsert: function(ideaAttributes) {
        ...
        Email.send({
            ...
            html: "<h4>" + idea.data.name + "</h4><h4>" + idea.data.email + "</h4><p>Resumo: " + idea.data.content + "</p><p>Público Alvo: " + idea.data.targetAudience + "</p><p>Modelo de Receitas: " + idea.data.monetization + "</p>",
        });
