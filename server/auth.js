 Accounts.onCreateUser(function(options, user) {
    ...
    if(user.services.facebook){ //Facebook
      user.emails = [{'adress': user.services.facebook.email, 'verified': true}];
      ...
      user.emails = [{'adress': user.services.google.email, 'verified': true}];
      ...
      user.emails = [{'adress': user.services.twitter.email, 'verified': true}];
